	...
	do
    {
        ...
        while(op<1||op>4)
        {
                  ...
                  switch(b)
                  {
                        case 1 : system("cls");
                                 for(i=0;i<10;i++)
                                  {
                                        if(*(*(bus+i))!=1)
                                        {
                                            *(*(bus+i))=1;
                                            printf("\n \t\t\t\t");
                                            printf("Operation Result : successfully booked and seat no is w%d\n",6*i+1);
                                            count=1;
                                            break;
                                        }
                                        if(*(*(bus+i)+5)!=1)
                                     ...
                                     if(count!=1) printf("\n \t\t\t\tOperation Result : Sorry no seat available");
                                     break;
                          case 2 :system("cls");
                                  for(i=0;i<10;i++)
                                  {
                                        if(*(*(bus+i)+2)!=1)
                                        {
                                            *(*(bus+i)+2)=1;
                                            count=1;
                                            printf("\n \t\t\t\tOperation Result : successfully booked and seat no is w%d\n",6*i+3);
                                            break;
                                        }
                                        if(*(*(bus+i)+3)!=1)
                                        {
                          ...
                          case 3 :system("cls");
                                  ...
                                  if(count==1) printf("\n \t\t\t\tOperation Result : seat reserved and seat no is w%d \n",6*i+j+1);
                                  else printf("\n \t\t\t\tOperation Result : sorry all seats reserved . good bye :)\n ");
                                  break;
                          case 4 :system("cls");
                                  break;
            ...
            case 2 : system("cls");
                     ...
                     {
                            *(*bus+j)=0;
                            printf("\n \t\t\t\tOperation Result : seat is cancelled\n");
                     }
                     break;
            case 3 : system("cls");
                     logo();
                    ...
                    {
                        printf("\n \t\t\t\t");
                        for(j=0;j<6;j++) printf(" w%02d-%d ",++k,bus[i][j]);
                        printf("\n");
                    }
                    printf("\n");
                    system("pause");
